...
<body>
    ...
    <!-- LOGO -->
        ...
        <li class="nav-item">
        <a class="nav-link" href="carrito.html"><font color="SIENNA" face="Freestyle Script" size="5"><strong><ul class="navbar-nav ml-auto">CARRITO(<?php echo (empty($_SESSION ['CARRITO']))?
        ...
        <font face="Forte">
        <h1 class="mt-5 display-4  text-center mb-5"><mark><font color="FUCHSIA">INGRESAR A MI CUENTA</font></mark></h1></font>
        </section>
    ...
    <!-- Grid column -->
        ...
        <h6 class="mb-0"><font face="Pristina" color="SIENNA" size="5"><strong><marquee behavior="alternate" direction="up" width="80%"><marquee direction="right">¡Siguenos en instagram!</marquee></marquee></strong></font></h6>
        </div>
        </div>
    <!-- Grid row-->
        </div>
    ...
    <!-- Links -->
        <h6 class="text-uppercase font-weight-bold"><font color="TOMATO" face="Arial" size="5">CONTACTO</font></h6>
                    <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                    <p>
