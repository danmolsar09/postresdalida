...
<footer class="page-footer font-small unique-color-dark" style="background-color: #E5BC8E">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a class="text-danger stretched-link" href="#!">CLASICOS</a>
        </p>
        <p>
          <a class="text-danger stretched-link" href="#!">PARA LA CALOR</a>
        </p>
        <p>
          <a class="text-danger stretched-link" href="#!">MEXICANISIMOS</a>
        </p>
        <p>
          <a class="text-danger stretched-link" href="#!">REGALA AMOR</a>
        </p>
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
           <a class="d-flex justify-content-center text-warning stretched-link" href="https://mail.google.com/mail/u/0/#inbox">
  ...
  <div class="footer-copyright text-center py-3">© 2020 Copyright:
    <a class="text-danger stretched-link" href="index.html"> REPOSTERÍA DALIDA</a>
  </div>
  <!-- Copyright -->
